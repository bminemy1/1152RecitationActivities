...
\begin{freeResponse} There is no ``-" in this expression, so we choose the substitution $ x = C \tan\theta$.  

\vspace{3mm}
Here, $4+9x^2 = 4 + 9C^2 \tan^2 \theta $ so we need $9C^2 = 4$, and thus \underline{$C=2/3$}.  Now make the trigonometric substitution:
\begin{align*}
x & = \dfrac{2}{3} \tan \theta \\
dx & = \dfrac{2}{3} \sec^2 \theta \, d\theta 
\end{align*}
...
&=  \int \dfrac{   \tan^2 \theta}{\sec \theta} \,  d\theta \hspace{3 mm}  \leftarrow \mbox{\color{red} neither $u=\sec \theta$ nor $u=\tan \theta$ will work! So, convert $\tan^2 \theta$! \color{black}}
\end{align*}
...
&= \boxed{\ln \left| \dfrac{\sqrt{4+9x^2}}{2}+\dfrac{3x}{2} \right| - \dfrac{3x}{\sqrt{4x^2+9}} +C} \\
\end{align*}
where we have used the triangle shown below to evaluate the trigonometric functions:
...
Since $x = \dfrac{2}{3} \tan \theta$, we have $  \tan \theta = \dfrac{3x}{2} $, which allows us to draw this triangle, from which we can read the expressions for the other trigonometric functions.
...
Evaluate the following integrals
	...
	Now, we again use equation \eqref{substitution1} along with Pythagorean's Theorem to construct the following triangle.
		...
		\begin{image}
		\includegraphics[trim= 230 270 250 280, scale=0.7]{Figure7-4-1.pdf}
		\end{image}
...
Evaluate the following integrals
	...
	Now, we again use equation \eqref{substitution2} along with Pythagorean's Theorem to construct the following triangle.
		...
		\begin{image}
		\includegraphics[trim= 270 350 250 330]{Figure7-4-6.pdf}
		\end{image}
	...
	We use equation \eqref{substitution3} along with Pythagorean's Theorem to construct the following triangle.
		...
		\begin{image}
		\includegraphics[trim= 270 350 250 330]{Figure7-4-7.pdf}
		\end{image}
	...
	\begin{freeResponse}
		...
		\begin{image}
		\includegraphics[trim= 270 350 250 360]{Figure7-4-8.pdf}
		\end{image}
