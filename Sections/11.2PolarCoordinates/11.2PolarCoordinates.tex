...
Plot the following (polar) points in the $xy$-plane and then rewrite them as rectangular coordinates.
	...
	\item  
		...
		%\begin{image}
		%\includegraphics[trim= 170 420 250 180]{Figure11-2-2.pdf}
		%\end{image}
	...
	\item  
		...
		%\begin{image}
		%\includegraphics[trim= 170 420 250 180]{Figure11-2-3.pdf}
		%\end{image}
	...
	\item  
		...
		%\begin{image}
		%\includegraphics[trim= 170 420 250 180]{Figure11-2-4.pdf}
		%\end{image}
	...
	\item  
		...
		%\begin{image}
		%\includegraphics[trim= 170 420 250 180]{Figure11-2-5.pdf}
		%\end{image}
...
Rewrite the rectangular point $(3,5)$ in polar coordinates in three different ways.
	...
	\item[i.]
		...
		%\begin{image}
		%\includegraphics[trim= 170 420 250 180]{Figure11-2-6.pdf}
		%\end{image}
	...
	\item[ii.]
		...
		%\begin{image}
		%\includegraphics[trim= 170 420 250 180]{Figure11-2-7.pdf}
		%\end{image}
	...
	\item[iii.]
		...
		%\begin{image}
		%\includegraphics[trim= 170 420 250 180]{Figure11-2-8.pdf}
		%\end{image}
...
Is $0 \leq \theta \leq 2 \pi$ necessary to complete the graph?
	...
	%\begin{image}
	%\includegraphics[trim= 170 420 250 180]{Figure11-2-1.pdf}
	%\end{image}
	...
	%\begin{image}
	%\includegraphics[trim= 170 420 250 180]{Figure11-2-9.pdf}
	%\end{image}
...
Graph $r = 2 + 4 \cos \theta$ using the ``Cartesian-to-Polar'' method.
	...
	%\begin{image}
	%\includegraphics[trim= 170 420 250 180]{Figure11-2-10.pdf}
	%\end{image}
	
	We then use this to draw the following graph in the $xy$-plane
	
	%\begin{image}
	%\includegraphics[trim= 170 420 250 180]{Figure11-2-11.pdf}
	%\end{image}
