...
Consider the region bounded by the curves $y=2x^2-7x+8$ and $y=x^2-4x+18$.
	\begin{enumerate}
		...
		\begin{freeResponse}
			\begin{image}
			\includegraphics[trim= 50 320 50 180,scale=0.6,angle=-89.99]{Figure2.pdf}
			\end{image}
		\end{freeResponse}
		...
		\begin{freeResponse}
			\begin{image}
			\includegraphics[trim= 120 250 130 180,scale=0.6,angle=-89.99]{Figure3.pdf}
			\end{image}
...
Set up a single integral that computes the area of the region bounded by the curves (and be sure to draw a sketch of the graphs).
	\begin{enumerate}
		...
		\begin{freeResponse}
			\begin{image}
			\includegraphics[trim= 30 270 50 180,scale=0.6,angle=-89.99]{Figure4.pdf}
			\end{image}
		Thus,
		\[
		...
		\begin{freeResponse}
			\begin{image}
			\includegraphics[trim= 100 270 100 180,scale=0.6,angle=-89.99]{Figure5.pdf}
			\end{image}
...
\begin{image}
\includegraphics[trim= 270 250 250 250]{Figure1.pdf}
\end{image}
	...
	\begin{enumerate}
		...
		\]
			\begin{image}
			\includegraphics[trim= 130 230 100 230,scale=0.8]{Figure6.pdf}
			\end{image}
		\end{freeResponse}
		...
		\]
			\begin{image}
			\includegraphics[trim= 130 250 100 250,scale=0.6]{Figure7.pdf}
			\end{image}
		\end{freeResponse}
