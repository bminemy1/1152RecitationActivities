...
\boxed{x=\left( 2 -\frac{1-\sqrt{3}}{2} \right) \frac{\sqrt{4-(\sqrt{3}-1)^2}}{2}} \\

	    Because this equation is symmetric across the $y$-axis (Note: $f(\pi-\theta)=2-\sin(\pi -\theta) = 2-\sin(\theta)$), the equation of the other vertical tangent line is \boxed{x=-\left( 2 -\frac{1-\sqrt{3}}{2} \right) \frac{\sqrt{4-(\sqrt{3}-1)^2}}{2}}.
